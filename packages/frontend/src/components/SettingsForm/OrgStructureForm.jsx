...
import {getDepartments, getPositions, getSettingsLoader} from "../../containers/Settings/redux/settingGetters";
import {
    fetchSettingCreate,
    fetchSettings
...
const OrgStructureForm = () => {
    ...
    return (
        <Form form={form}
            ...
            >
                <Checkbox>
                    Главный этого отдела
                </Checkbox>
            </Form.Item>
            <Form.Item>
                <Button loading={isLoading} type="primary" htmlType="submit" size={"middle"}>
                    Создать
                </Button>
            </Form.Item>
        </Form>
