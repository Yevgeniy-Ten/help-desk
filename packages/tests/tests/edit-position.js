...
// Дравер оупен
When("откроется форма редактирования должности {string}", (text) => {
  I.see(text);
  I.wait(1);
});
// edit имя должности
When(
  "в поле должности с айди {string} введу текст {string}",
  (fieldName, value) => {
    I.fillField({ id: fieldName }, value);
    I.wait(1);
  }
...
// "увижу отредактированную должность"
