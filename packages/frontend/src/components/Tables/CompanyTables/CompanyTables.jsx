...
import {getCompanies, getEditableElement, getSettingsLoader} from "../../../containers/Settings/redux/settingGetters";
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (_, record) => {
                ...
                return editable ? (
                    <Space>
                        <Button onClick={saveEditableCompany}>
                            Сохранить изменения
                        </Button>
