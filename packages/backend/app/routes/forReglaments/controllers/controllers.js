...
const ReglamentsController = {
    async createRules(req, res) {
        try {
            ...
            LogCreator.createUserErrorLog(`${req.user.firstName} ${req.user.lastName}`, `when create reglament`, errors)
    ...
    async editReglaments(req, res) {
        try {
            ...
            LogCreator.createUserErrorLog(`${req.user.firstName} ${req.user.lastName}`, `when update reglament`, e)
