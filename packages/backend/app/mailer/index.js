        ...
        try {
            ...
            await this.transporter.sendMail({
                ...
                html: `<div style="display: flex; justify-content: center">
                                <h3>${message ? message.message : "Пожалуйста кликните на кнопку и потвердите ваш email!"}</h3>
<a href="${link}" target="_blank" style="background: #40a9ff; border: 1px solid #ccc; color:#fff; text-decoration: none; font-size: 20px; border-radius: 6px; padding: 10px;">Потвердить email!</a></div>`
            });
        } catch (error) {
